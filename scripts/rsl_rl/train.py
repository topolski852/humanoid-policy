...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # Write Isaac Lab internal logs outside the run-discovery tree to avoid
    # get_checkpoint_path picking up this directory alphabetically over timestamped runs.
    isaaclab_log_dir = os.path.join("logs", "isaaclab")
