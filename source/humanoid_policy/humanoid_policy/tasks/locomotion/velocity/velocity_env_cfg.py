...
class LocomotionVelocityEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: FlatTerrainSceneCfg = FlatTerrainSceneCfg(num_envs=16384, env_spacing=2.5)
    ...
    def __post_init__(self):
        ...
        # like the reference setup (which ran 16384 envs on this 16 GB card fine). Enlarging them starves VRAM and
